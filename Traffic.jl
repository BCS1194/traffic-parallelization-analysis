...
module Traffic
  ...
  export Road, Car, initRoads, initCar, nextRoad
  ...
  function initCar(roads)
    println("Initializing Car with weight 2\n")
  ...
  function nextRoad(car, roads)
    println("Leaving Road $(car.currentRoad.roadNum)")
    ...
    println("Now on Road $(car.currentRoad.roadNum)") 
    car.currentRoad.travelCost += car.travelWeight
