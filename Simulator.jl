...
println("Our implementation uses a function caled simulate, which uses the following parameters:")
println("    int cars, TODO: bool accidents")
println("    \"cars\" is the number of cars you would like to run through the environment.")
println("    TODO: \"accidents\" is a boolean that will enable enable accidents on heavily congested raods.\n") 
